...
function installEventSourceMock() {
    if (window.__HNH_EVENT_SOURCE_INSTALLED__) {
        return;
    }
    window.__HNH_EVENT_SOURCE_INSTALLED__ = true;
    window.__HNH_MOCK_TILES__ = true;
    class MockEventSource {
        constructor(url) {
            ...
            sendBatch();
            this.interval = setInterval(sendBatch, 4000);
        }
